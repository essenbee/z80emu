    ...
    public partial class Z80
    {
        ...
        public Z80()
        {
            ...
            CBInstructions = new Dictionary<byte, Instruction>
            {
                ...
                { 0x30, new Instruction("SLL B", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x31, new Instruction("SLL C", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x32, new Instruction("SLL D", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x33, new Instruction("SLL E", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x34, new Instruction("SLL H", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x35, new Instruction("SLL L", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
                { 0x36, new Instruction("SLL (HL)", RGIHL, IMP, SLLHL, new List<int>{ 4, 4, 4, 3 }) },
                { 0x37, new Instruction("SLL A", IMP, IMP, SLLR, new List<int>{ 4, 4 }) },
            ...
            {
                { 0x00, new Instruction("RLC (IX+d),B", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x01, new Instruction("RLC (IX+d),C", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x02, new Instruction("RLC (IX+d),D", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x03, new Instruction("RLC (IX+d),E", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x04, new Instruction("RLC (IX+d),H", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x05, new Instruction("RLC (IX+d),L", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x06, new Instruction("RLC (IX+d)", RELS, IDX, RLCIXD, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x07, new Instruction("RLC (IX+d),A", RELS, IDX, RLCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x08, new Instruction("RRC (IX+d),B", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x09, new Instruction("RRC (IX+d),C", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0A, new Instruction("RRC (IX+d),D", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0B, new Instruction("RRC (IX+d),E", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0C, new Instruction("RRC (IX+d),H", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0D, new Instruction("RRC (IX+d),L", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0E, new Instruction("RRC (IX+d)", RELS, IDX, RRCIXD, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x0F, new Instruction("RRC (IX+d),A", RELS, IDX, RRCIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x10, new Instruction("RL (IX+d),B", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x11, new Instruction("RL (IX+d),C", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x12, new Instruction("RL (IX+d),D", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x13, new Instruction("RL (IX+d),E", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x14, new Instruction("RL (IX+d),H", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x15, new Instruction("RL (IX+d),L", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x16, new Instruction("RL (IX+d)", RELS, IDX, RLIXD, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x17, new Instruction("RL (IX+d),A", RELS, IDX, RLIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x18, new Instruction("RR (IX+d),B", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x19, new Instruction("RR (IX+d),C", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1A, new Instruction("RR (IX+d),D", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1B, new Instruction("RR (IX+d),E", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1C, new Instruction("RR (IX+d),H", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1D, new Instruction("RR (IX+d),L", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1E, new Instruction("RR (IX+d)", RELS, IDX, RRIXD, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x1F, new Instruction("RR (IX+d),A", RELS, IDX, RRIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x20, new Instruction("SLA (IX+d),B", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x21, new Instruction("SLA (IX+d),C", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x22, new Instruction("SLA (IX+d),D", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x23, new Instruction("SLA (IX+d),E", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x24, new Instruction("SLA (IX+d),H", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x25, new Instruction("SLA (IX+d),L", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x26, new Instruction("SLA (IX+d)", RELS, IDX, SLAIXD, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
                { 0x27, new Instruction("SLA (IX+d),A", RELS, IDX, SLAIXD2, new List<int>{ 4, 4, 3, 5, 4, 3 }) },
