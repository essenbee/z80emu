...
namespace Essenbee.Z80.Tests
{
    public class EightBitLogicGroupShould
    {
        ...
        [Fact]
        public void XorAccumulatorWithRegisterB()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x96, B = 0x5D, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        public void XorAccumulatorWithByteAtLocationPointedToByHL()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x96, H = 0x09, L = 0x00, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        public void XorAccumulatorWithByte()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x96, B = 0x00, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        public void XorAccumulatorWithByteAtLocationPointedToByIXPlusD()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x96, IX = 0x0900, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        public void XorAccumulatorWithByteAtLocationPointedToByIYPlusD()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x96, IY = 0x0900, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        public void XorAccumulatorWithItselfZeroesAccumulator()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            {
                // Program Code
                { 0x0080, 0xAF }, // XOR A - a 1-byte way of loading A with zero
                { 0x0081, 0x00 },
                { 0x0082, 0x00 },
                { 0x0083, 0x00 },
                { 0x0084, 0x00 },
            ...
            var cpu = new Z80() { A = 0x42, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
