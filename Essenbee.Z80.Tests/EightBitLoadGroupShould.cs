...
namespace Essenbee.Z80.Tests
{
    public class EightBitLoadGroupShould
    {
        ...
        [Fact]
        public void LoadAfromRwhenOperationIsLDAR_GivenRisPositive()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x0F, R = 0x17, IFF2 = true, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
            cpu.Tick();
        ...
        [Fact]
        public void LoadAfromRwhenOperationIsLDAR_GivenRisNegative()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x0F, R = 0xFA, IFF2 = true, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
            cpu.Tick();
        ...
        [Fact]
        public void LoadAfromRwhenOperationIsLDAR_GivenRisZero()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x0F, R = 0x00, IFF2 = true, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
            cpu.Tick();
