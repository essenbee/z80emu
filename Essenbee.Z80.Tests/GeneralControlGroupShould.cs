...
namespace Essenbee.Z80.Tests
{
    public class GeneralControlGroupShould
    {
        ...
        [Fact]
        private void SetCarryFlagUndocumentedFlags1()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0x00, F = (Flags)0b1111_1111, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        private void SetCarryFlagUndocumentedFlags2()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0xFF, F = (Flags)0b0000_0000, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
        ...
        [Fact]
        private void SetCarryFlagUndocumentedFlags3()
        {
            var fakeBus = A.Fake<IBus>();
            ...
            var cpu = new Z80() { A = 0xFF, F = (Flags)0b1111_1111, PC = 0x0080 };
            cpu.ConnectToBus(fakeBus);
